...
function add_loaded_to_table(){
    ...
    $.each(last_bill_detail, function (i) {
        ...
        $.get(`/api/bill_detail/${last_bill_detail[i]}/`, function (data) {
            ...
            add_new_row(parseFloat(data.bill_detail_product), 'desc', parseFloat(data.bill_detail_amount), 'uni',
                parseFloat(data.bill_detail_price), parseFloat(data.bill_detail_total) )
