...
},{"./bill/edit/":2,"./bill/new/":3,"./order/edit/":5,"./order/new/":6,"./report/by_order/":8,"./request/edit/":10,"./request/new/":11,"PriceFormat":13,"alertify":14,"bootstrap":15,"jquery":18,"page":19,"select2":23}],2:[function(require,module,exports){
var $ = require('jquery');
var page = require('page');
...
function edit_bill() {
    ...
    let id = JSON.parse(localStorage.bill_to_edit);

    bill_id = id.id;

    $('.order_header').text(`Editar Factura de compra # ${ bill_id }`);
...
function load_bill(id) {
    ...
    $.get(`/api/bills/${ id }/`, function (data) {
...
function add_loaded_to_table() {
    ...
    $.each(last_bill_detail, function (i) {

        $.get(`/api/bill_detail/${ last_bill_detail[i] }/`, function (data) {

            add_new_row(data.bill_detail_product_code, data.bill_detail_description, parseFloat(data.bill_detail_amount), data.bill_detail_unit, parseFloat(data.bill_detail_price), parseFloat(data.bill_detail_total), data.bill_detail_product, data.bill_detail_discount, data.bill_detail_iv);
        });
    });
}
...
},{"../new/template.jade":4,"jquery":18,"page":19}],3:[function(require,module,exports){
var $ = require('jquery');
var page = require('page');
...
},{"./template.jade":4,"jquery":18,"page":19}],4:[function(require,module,exports){
...
function add_product() {
    ...
    if (is_on_array === -1) {
        ...
        if (products.length) {
            ...
            add_new_row(products[0].product_code, products[0].product_description, qty, products[0].product_unit, products[0].product_price, subt, products[0].id, products[0].product_discount, iv, pudisc); //las 0 is disc
        } else {
            //FALTA mensaje de que no existe el producto
            alert('NO EXISTE EL PRODUCTO');
        }
...
function add_loaded_to_table() {
    ...
    $.each(last_order_detail, function (i) {
        ...
        $.get(`/api/order_detail/${ last_order_detail[i] }/`, false).success(function (data) {
            ...
            add_new_row(data.order_detail_product_code, data.order_detail_description, parseFloat(data.order_detail_amount), data.order_detail_unit, parseFloat(data.order_detail_price), parseFloat(data.order_detail_total), data.order_detail_product, data.order_detail_discount, data.order_detail_iv, pudisc);
        });
    });
}
...
},{"../new/template.jade":7,"jquery":18,"page":19}],6:[function(require,module,exports){
var $ = require('jquery');
var page = require('page');
...
function add_product() {
    ...
    if (is_on_array === -1) {
        ...
        if (products.length) {
            ...
            add_new_row(products[0].product_code, products[0].product_description, qty, products[0].product_unit, products[0].product_price, subt, products[0].id, products[0].product_discount, iv, pudisc); //last 0 is disc
        } else {
            //FALTA mensaje de que no existe el producto
            alert('NO EXISTE EL PRODUCTO');
        }
...
},{"./template.jade":7,"jquery":18,"page":19}],7:[function(require,module,exports){
var jade = require("jade/runtime");
...
function add_product() {
    ...
    if (is_on_array === -1) {
        ...
        if (products.length) {
            ...
            add_new_row(products[0].product_code, products[0].product_description, qty, products[0].product_unit, products[0].id); //last 0 is disc
        } else {
            //FALTA mensaje de que no existe el producto
            alert('NO EXISTE EL PRODUCTO');
        }
...
function add_loaded_to_table() {
    ...
    $.each(last_request_detail, function (i) {
        ...
        $.get(`/api/request_detail/${ last_request_detail[i] }/`, false).success(function (data) {
            add_new_row(data.request_detail_product_code, data.request_detail_description, parseFloat(data.request_detail_amount), data.request_detail_unit, data.request_detail_product);
        });
    });
}
...
},{"../new/template.jade":12,"jquery":18,"page":19}],11:[function(require,module,exports){
var $ = require('jquery');
var page = require('page');
...
},{"./template.jade":12,"jquery":18,"page":19}],12:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div style=\"padding-top:20px;padding-left:40px;\" class=\"main-page-cont\"><div class=\"col-xs-12 no-padding-left\"><form><div class=\"form-group row\"><div class=\"col-xs-6\"><H3 class=\"request_header\">Nueva Orden de Pedido:</H3></div><!--.col-xs-6--><!--    ul.object-tools: li: a(href=\"/admin/bills/bill/\").returnlink Volver--></div></form></div><div style=\"margin-top:20px\" class=\"col-md-3 no-padding-left\"><form><!--fecha y proveedor--><div class=\"form-group row\"><div class=\"col-xs-6 col-md-12 no-padding-left\"><div class=\"col-xs-12\"><span>Fecha:</span></div><div class=\"col-xs-12\"><input type=\"date\" class=\"form-control new_request_date\"/></div></div></div><!--proyecto y actividad--><div class=\"form-group row\"><div class=\"col-xs-6 col-md-12 no-padding-left\"><div class=\"col-xs-12\"><span>Proyecto:</span></div><div class=\"col-xs-12\"><select class=\"form-control new_request_project\"><option></option></select></div></div><div class=\"col-xs-6 col-md-12 no-padding-left bottom_row\"><div class=\"col-xs-12\"><span>Actividad:</span></div><div class=\"col-xs-12\"><select class=\"form-control new_request_activity\"><option></option></select></div></div></div><!--producto y buscar--><div class=\"form-group row\"><div class=\"col-xs-6 col-md-12 no-padding-left\"><div class=\"col-xs-12\"><span>Producto:<!--a(href=\"/admin/products/product/add/?_popup=1\").pull-right.popup_product.related-widget-wrapper-link.add-related--><span class=\"pull-right\"><i id=\"add_id_product\" class=\"glyphicon glyphicon-plus-sign popup_product related-widget-wrapper-link add-related\"></i></span><span style=\"padding-right:10px;text-aling:center\" class=\"pull-right\"><i class=\"glyphicon glyphicon-refresh refresh_product\"></i></span></span></div><div class=\"col-xs-12 inner-addon right-addon\"><i class=\"glyphicon glyphicon-barcode\"></i><input type=\"text\" id=\"id_product\" class=\"form-control request_product_code\"/></div></div><div class=\"col-xs-6 col-md-12 no-padding-left bottom_row\"><div class=\"col-xs-12\"><span>Buscar:</span></div><div class=\"col-xs-12\"><select class=\"form-control new_request_search\"><option></option></select></div></div></div></form></div><div class=\"col-md-9 no-padding-left\"><form><!--tabla--><div class=\"form-group row table_row product_table_row\"><div class=\"col-xs-12\"><table class=\"table table-bordered NO_table\"><thead><tr><th>Códi</th><th>Desc</th><th>Cant</th><th>Unid</th><th></th></tr></thead><tbody class=\"table-body\"></tbody></table></div></div><!--confirmar y guardar--><div style=\"padding-right:15px;\" class=\"form-group row\"><div class=\"col-xs-12 no-padding-left\"><button type=\"button\" class=\"BTN_NO Btn_Confirm form-control btn btn-default pull-right\">Confirmar</button></div><div class=\"col-xs-12 no-padding-left\"><button type=\"button\" class=\"BTN_NO Btn_Edit form-control btn btn-default pull-right\">Editar</button></div><div class=\"col-xs-12 no-padding-left\"><button type=\"button\" class=\"BTN_NO Btn_Save form-control btn btn-default pull-right\">Guardar</button></div></div></form></div></div>");;return buf.join("");
};
...
; browserify_shim__define__module__export__(typeof PriceFormat != "undefined" ? PriceFormat : window.PriceFormat);
...
!function (a) {
  ...
  function b(a, b) {
    ...
    if (null === a) return a;var b;if (Array.isArray(a)) {
      b = [];for (var c = 0; c < a.length; c += 1) b.push(h(a[c]));return b;
    }if (a instanceof Date) return new Date(a.getTime());if (a instanceof RegExp) return b = new RegExp(a.source), b.global = a.global, b.ignoreCase = a.ignoreCase, b.multiline = a.multiline, b.lastIndex = a.lastIndex, b;if ("object" == typeof a) {
      b = {};for (var d in a) a.hasOwnProperty(d) && (b[d] = h(a[d]));return b;
    }return a;
  }function i(a, b) {
    ...
    return function () {
      if (arguments.length > 0) {
        for (var c = [], d = 0; d < arguments.length; d += 1) c.push(arguments[d]);return c.push(a), b.apply(a, c);
    ...
    }var d = {};return { defaults: o, dialog: function (d, e, f, g) {
        if ("function" != typeof e) return b(d);if (this.hasOwnProperty(d)) throw new Error("alertify.dialog: name already exists");var h = c(d, e, f, g);f ? this[d] = function () {
    ...
    var a,
        b,
        c = !1,
        d = { animation: "animationend", OAnimation: "oAnimationEnd oanimationend", msAnimation: "MSAnimationEnd", MozAnimation: "animationend", WebkitAnimation: "webkitAnimationEnd" };for (a in d) if (void 0 !== document.documentElement.style[a]) {
      b = d[a], c = !0;break;
    ...
    function m(a) {
      if (!a.__internal) {
        delete a.__init, a.__settings || (a.__settings = h(a.settings)), null === za && document.body.setAttribute("tabindex", "0");var c;"function" == typeof a.setup ? (c = a.setup(), c.options = c.options || {}, c.focus = c.focus || {}) : c = { buttons: [], focus: { element: null, select: !1 }, options: {} }, "object" != typeof a.hooks && (a.hooks = {});var d = [];if (Array.isArray(c.buttons)) for (var e = 0; e < c.buttons.length; e += 1) {
          var f = c.buttons[e],
              g = {};for (var i in f) f.hasOwnProperty(i) && (g[i] = f[i]);d.push(g);
      ...
      for (var c = p.indexOf(b), d = c + 1; d < p.length; d += 1) if (p[d].isModal()) return;return document.body.lastChild !== b.elements.root && (document.body.appendChild(b.elements.root), p.splice(p.indexOf(b), 1), p.push(b), W(b)), !1;
    }function C(a, d, e, f) {
      switch (d) {case "title":
      ...
      var f = { op: void 0, items: [] };if ("undefined" == typeof e && "string" == typeof d) f.op = "get", b.hasOwnProperty(d) ? (f.found = !0, f.value = b[d]) : (f.found = !1, f.value = void 0);else {
        var g;if (f.op = "set", "object" == typeof d) {
          var h = d;for (var i in h) b.hasOwnProperty(i) ? (b[i] !== h[i] && (g = b[i], b[i] = h[i], c.call(a, i, g, h[i])), f.items.push({ key: i, value: h[i], found: !0 })) : f.items.push({ key: i, value: h[i], found: !1 });
        } else {
      ...
      var c = a.srcElement || a.target;switch (c) {case b.elements.commands.pin:
      ...
      var c = a.srcElement || a.target;return Fa || c !== b.elements.modal || b.get("closableByDimmer") !== !0 || E(b), Fa = !1, !1;
    }function S(a, b) {
      for (var c = 0; c < a.__internal.buttons.length; c += 1) {
        var d = a.__internal.buttons[c];if (!d.element.disabled && b(d)) {
          var e = k(c, d);"function" == typeof a.callback && a.callback.apply(a, [e]), e.cancel === !1 && a.close();break;
        }
      }
    }function T(a, b) {
      ...
      if (Ga) return void (Ga = !1);var b = p[p.length - 1],
          c = a.keyCode;return 0 === b.__internal.buttons.length && c === n.ESC && b.get("closable") === !0 ? (E(b), !1) : ya.indexOf(c) > -1 ? (S(b, function (a) {
        return a.key === c;
      }), !1) : void 0;
    }function V(a) {
      var b = p[p.length - 1],
          c = a.keyCode;if (c === n.LEFT || c === n.RIGHT) {
        for (var d = b.__internal.buttons, e = 0; e < d.length; e += 1) if (document.activeElement === d[e].element) switch (c) {case n.LEFT:
      ...
      if (b) b.focus();else {
        var c = a.__internal.focus,
            d = c.element;switch (typeof c.element) {case "number":
            a.__internal.buttons.length > c.element && (d = a.get("basic") === !0 ? a.elements.reset[0] : a.__internal.buttons[c.element].element);break;case "string":
      ...
      var c = a[Ka] - Ia,
          d = a[La] - Ja;Na && (d -= document.body.scrollTop), b.style.left = Math.min(Ma.maxLeft, Math.max(Ma.minLeft, c)) + "px", Na ? b.style.top = Math.min(Ma.maxTop, Math.max(Ma.minTop, d)) + "px" : b.style.top = Math.max(Ma.minTop, d) + "px";
    }function aa(a, c) {
      if (null === Pa && !c.isMaximized() && c.get("movable")) {
        var d,
          ...
          var g = c.elements.dialog;if (b(g, Ca.capture), g.style.left && (e = parseInt(g.style.left, 10)), g.style.top && (f = parseInt(g.style.top, 10)), Ia = d[Ka] - e, Ja = d[La] - f, c.isModal() ? Ja += c.elements.modal.scrollTop : c.isPinned() && (Ja -= document.body.scrollTop), c.get("moveBounded")) {
            var h = g,
                i = -e,
                j = -f;do i += h.offsetLeft, j += h.offsetTop; while (h = h.offsetParent);Ma = { maxLeft: i, minLeft: -i, maxTop: document.documentElement.clientHeight - g.clientHeight - j, minTop: -j }, Oa = _;
      ...
      var e = b,
          f = 0,
          g = 0;do f += e.offsetLeft, g += e.offsetTop; while (e = e.offsetParent);var h, i;c === !0 ? (h = a.pageX, i = a.pageY) : (h = a.clientX, i = a.clientY);var j = d();if (j && (h = document.body.offsetWidth - h, isNaN(Qa) || (f = document.body.offsetWidth - f - b.offsetWidth)), b.style.height = i - g + Ta + "px", b.style.width = h - f + Ta + "px", !isNaN(Qa)) {
      ...
      r(a.elements.modal, "click", a.__internal.modalClickHandler);
        ...
        Ra = 0,
        Sa = 0,
        Ta = 0;return { __init: m, isOpen: function () {
        ...
        if (!isNaN(a) && !isNaN(b)) {
          l("onmove", this);var c = this.elements.dialog,
              e = c,
              f = 0,
              g = 0;c.style.left && (f -= parseInt(c.style.left, 10)), c.style.top && (g -= parseInt(c.style.top, 10));do f += e.offsetLeft, g += e.offsetTop; while (e = e.offsetParent);var h = a - f,
        ...
        var c = this,
          ...
          C(c, a, b, d);
        }, a, b);if ("get" === d.op) return d.found ? d.value : "undefined" != typeof this.settings ? D(this, this.settings, this.settingUpdated || function () {}, a, b).value : void 0;if ("set" === d.op) {
          if (d.items.length > 0) for (var e = this.settingUpdated || function () {}, f = 0; f < d.items.length; f += 1) {
            var g = d.items[f];g.found || "undefined" == typeof this.settings || D(this, this.settings, e, g.key, g.value);
          }return this;
        }
      }, set: function (a, b) {
    ...
    function d(a) {
      ...
      switch (l.className = n.base, a.__internal.position) {case "top-right":
          ...
          b(l, n.top + " " + n.left);break;case "bottom-left":
          b(l, n.bottom + " " + n.left);break;default:case "bottom-right":
      ...
      function i(a, b) {
        ...
        clearTimeout(a.__internal.timer), clearTimeout(a.__internal.transitionTimeout);
          ...
          if (!this.__internal.pushed) {
            e(this), p(this);var d, f;switch (arguments.length) {case 0:
                ...
                d = a, f = c;}return "undefined" != typeof d && this.setContent(d), u.__internal.position.indexOf("top") < 0 ? l.appendChild(this.element) : l.insertBefore(this.element, l.firstChild), k = this.element.offsetWidth, b(this.element, n.visible), q(this.element, "click", this.__internal.clickHandler), this.delay(f);
          }return this;
        }, ondismiss: function () {}, callback: h, dismiss: function (a) {
        ...
        l,
        m = [],
        n = { base: "alertify-notifier", message: "ajs-message", top: "ajs-top", right: "ajs-right", bottom: "ajs-bottom", left: "ajs-left", visible: "ajs-visible", hidden: "ajs-hidden" };return { setting: function (a, b) {
        if (d(this), "undefined" == typeof b) return this.__internal[a];switch (a) {case "position":
    ...
    return { main: function (a, b, c) {
      ...
      }, build: function () {}, prepare: function () {}, setMessage: function (a) {
        this.setContent(a);
        ...
        if ("function" == typeof this.get("onok")) {
          var b = this.get("onok").call(this, a);"undefined" != typeof b && (a.cancel = !b);
        }
      } };
    ...
    function a(a) {
      ...
      a(b), c.duration = e, c.index = d, c.text = b.__internal.buttons[d].element.innerHTML, c.timer = setInterval(j(b, c.task), 1e3), c.task(null, b);
        ...
        if (d.isOpen()) {
          if (d.__internal.buttons[c.index].element.innerHTML = c.text + " (&#8207;" + c.duration + "&#8207;) ", c.duration -= 1, -1 === c.duration) {
            a(d);var e = d.__internal.buttons[c.index],
                f = k(c.index, e);"function" == typeof d.callback && d.callback.apply(d, [f]), f.close !== !1 && d.close();
          }
        } else a(d);
        ...
        switch (a) {case "message":
            ...
            c === !0 ? this.elements.buttons.primary.appendChild(this.__internal.buttons[0].element) : this.elements.buttons.primary.appendChild(this.__internal.buttons[1].element);break;case "defaultFocus":
            this.__internal.focus.element = "ok" === c ? 0 : 1;}
      }, callback: function (b) {
        a(this);var c;switch (b.index) {case 0:
            "function" == typeof this.get("onok") && (c = this.get("onok").call(this, b), "undefined" != typeof c && (b.cancel = !c));break;case 1:
    ...
    var b = document.createElement("INPUT"),
        c = document.createElement("P");return { main: function (a, b, c, d, e) {
      ...
      }, prepare: function () {}, setMessage: function (b) {
        ...
        var c;switch (a.index) {case 0:
            this.settings.value = b.value, "function" == typeof this.get("onok") && (c = this.get("onok").call(this, a, this.settings.value), "undefined" != typeof c && (a.cancel = !c));break;case 1:
...
},{"fs":16}],18:[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
/*!
...
},{"_process":22,"path-to-regexp":20}],20:[function(require,module,exports){
...
; browserify_shim__define__module__export__(typeof select2 != "undefined" ? select2 : window.select2);
